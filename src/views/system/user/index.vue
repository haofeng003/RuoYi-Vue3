    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <span v-hasPermi="['system:user:add']" style="color: red">
              如果不确定班长是谁,可以先以班级名为用户账号,后期再修改
            </span>
          </el-col>
        ...
        <el-table v-loading="loading" :data="userList" height="500" @selection-change="handleSelectionChange">
          <!--          <el-table-column align="center" type="selection" width="50"/>-->
          <el-table-column align="center" label="序号" type="index" width="100"/>
          <el-table-column v-if="columns[0].visible" key="clazzId" align="center" label="班级" prop="clazzId">
            <template #default="scope">
              <div v-for="clazz in ClazzList" :key="clazz.id">
            <span v-if="clazz.id === scope.row.clazzId">
                  {{ clazz.name }}
            </span>
              </div>
            </template>
          ...
          <el-table-column v-if="columns[6].visible" align="center" label="创建时间" prop="createTime" width="250">
            <template #default="scope">
              <span>{{ parseTime(scope.row.createTime) }}</span>
            </template>
          </el-table-column>
          <el-table-column v-hasPermi="['system:user:edit']" align="center" class-name="small-padding fixed-width"
                           label="操作" width="300">
            <template #default="scope">
              <div style="display: flex; justify-content: space-between;">
                ...
                <el-tooltip v-if="scope.row.userId !== 1" content="分配角色" placement="top">
                  <el-button v-hasPermi="['system:user:export']" icon="CircleCheck" link type="primary"
      ...
      <el-form ref="userRef" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            ...
            <el-form-item v-if="form.userId != undefined" label="用户账号:">
              <span>
                用户登录时的账号请勿随意修改
              </span>
            </el-form-item>
          ...
          <el-col :span="12">
            ...
            <el-form-item v-hasPermi="['system:user:export']" label="角色">
